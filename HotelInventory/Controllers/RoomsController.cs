...
namespace HotelInventory.Controllers
{
    public class RoomsController : Controller
    {
        ...
        {
            var inventoryContext = _context.Rooms.Include(r => r.Amenity).Include(r => r.Hotel);
        ...
        public async Task<IActionResult> Create([Bind("ID,HotelID,AmenityID")] Room room)
        {
            ...
            ViewData["AmenityID"] = new SelectList(_context.Amenities, "ID", "ID", room.AmenityID);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,HotelID,AmenityID")] Room room)
        {
            if (id != room.ID)
            {
                return NotFound();
